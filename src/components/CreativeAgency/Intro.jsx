              ...
              <div className="row">
                <div className="col-lg-12">
                  <div className="text mt-20">
                    <p>
                      We proudly serve diverse industries with advanced
                      technology solutions and innovative display products.
                      Whether you're starting a new business or expanding an
                      existing one, we're here to support you every step of the
                      way.
                    </p>
                  </div>
