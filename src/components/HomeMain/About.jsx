    ...
    <>
      <section className="about-intro section-about">
        <div className="container">
          <h6 className="text-center dot-titl-non fadeInUp">Who We Are</h6>
          <div className="mb-40 align-middle row">
            <div className="col-lg-5">
              ...
              >
                <h2 className=" d-rotate wow fadeInUp">
                  <span className="">
            ...
            <div
              className="col-lg-5 offset-lg-2 valign fadeInUp"
              style={{ marginTop: "15px" }}
            >
              <div className="text">
                <p className="d-slideup wow">
                  <span className="">
                    <span className="up-text fadeIn">
                  ...
                  <span className="sideup-text fadeIn">
                    <span className="">
