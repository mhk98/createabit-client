  ...
  [9799],
  {
    ...
    80644: function (e, s, t) {
      ...
      var r = t(85893),
        ...
        f = () => {
          let e = (0, u.useRouter)(),
            [s, t] = (0, n.useState)({ Email: "", Password: "" }),
            o = (e) => {
          ...
          let a = async (t) => {
            ...
            try {
              ...
              t.data.data.accessToken &&
                (m.ZP.success("Successfully Logged In"),
                localStorage.setItem("userId", t.data.data.user.User_ID),
                e.push("/")),
                (0, h.MG)({ accessToken: t.data.data.accessToken });
            } catch (e) {
          ...
          return (0, r.jsxs)("div", {
            ...
            children: [
              (0, r.jsx)("h3", { className: "", children: "Login" }),
              (0, r.jsxs)("form", {
                onSubmit: a,
              ...
              (0, r.jsxs)("p", {
                className: "mt-2",
                children: [
                  (0, r.jsx)("span", { children: "Don't have account?" }),
                  (0, r.jsx)("span", {
                    children: (0, r.jsxs)(d(), {
                      href: "/dark/register",
            ...
            children: [
              (0, r.jsx)(a(), {
                children: (0, r.jsx)("title", {
                  children: "Createabit - User Login",
                }),
              }),
              (0, r.jsx)(p.Z, {}),
              (0, r.jsxs)("div", {
      ...
      v.getLayout = (e) => (0, r.jsx)(l.Z, { children: e });
      var x = v;
    },
